...
test('div', () => {
  ...
  assert.deepEqual(React.createElement('div', attrs, children), div(attrs, children))
})
...
test('arbitrary tag', () => {
  ...
  htmlTagNames.forEach(tag => {
    ...
    assert.deepEqual(React.createElement(tag, attrs, children), hypeltag(attrs, children))
  })
})
...
test('arbitrary selector', () => {
  ...
  assert.deepEqual(React.createElement('div' + className, attrs), div(className, attrs))
  assert.deepEqual(React.createElement('div' + className, children), div(className, children))
  assert.deepEqual(React.createElement('div' + className, attrs, children), div(className, attrs, children))
  ...
  assert.deepEqual(React.createElement('div' + id, attrs, children), div(id, attrs, children))
})
